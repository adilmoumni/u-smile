        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20">
          ...
          <div className="mb-32">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-12 h-12 bg-[#a59c94] rounded-tl-full" />
            ...
            <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 lg:p-16 shadow-sm">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="order-1 lg:order-2 relative h-[350px] lg:h-[450px]">
                  <Image
                    src="/images/cabinet/wire-bending.png"
          ...
          <div className="mb-20">
            ...
            <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 lg:p-16 shadow-sm">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="order-2 relative h-[350px] lg:h-[450px]">
                  <Image
