// U-Smile Premium Email Templates
 ...
 */
export const getAdminEmailHtml = (data: EmailData) => {
...
/**
 * Generates the HTML for the Patient confirmation email.
 */
export const getUserEmailHtml = (data: EmailData) => {
